...
import { OrdersImsComponent } from 'app/entities/orders-ims/orders-ims.component';
...
describe('Component Tests', () => {
    describe('OrdersIms Management Component', () => {
        let comp: OrdersImsComponent;
        let fixture: ComponentFixture<OrdersImsComponent>;
        let service: OrdersImsService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [InventoryManagementSystemTestModule],
                declarations: [OrdersImsComponent],
                providers: [
                    {
                ...
                .overrideTemplate(OrdersImsComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(OrdersImsComponent);
