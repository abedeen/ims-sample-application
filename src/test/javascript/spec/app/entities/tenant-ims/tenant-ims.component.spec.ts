...
import { TenantImsComponent } from 'app/entities/tenant-ims/tenant-ims.component';
...
describe('Component Tests', () => {
    describe('TenantIms Management Component', () => {
        let comp: TenantImsComponent;
        let fixture: ComponentFixture<TenantImsComponent>;
        let service: TenantImsService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [InventoryManagementSystemTestModule],
                declarations: [TenantImsComponent],
                providers: [
                    {
                ...
                .overrideTemplate(TenantImsComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(TenantImsComponent);
