...
import { UsersImsComponent } from 'app/entities/users-ims/users-ims.component';
...
describe('Component Tests', () => {
    describe('UsersIms Management Component', () => {
        let comp: UsersImsComponent;
        let fixture: ComponentFixture<UsersImsComponent>;
        let service: UsersImsService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [InventoryManagementSystemTestModule],
                declarations: [UsersImsComponent],
                providers: [
                    {
                ...
                .overrideTemplate(UsersImsComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(UsersImsComponent);
