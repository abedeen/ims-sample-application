...
import { StockImsComponent } from 'app/entities/stock-ims/stock-ims.component';
...
describe('Component Tests', () => {
    describe('StockIms Management Component', () => {
        let comp: StockImsComponent;
        let fixture: ComponentFixture<StockImsComponent>;
        let service: StockImsService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [InventoryManagementSystemTestModule],
                declarations: [StockImsComponent],
                providers: [
                    {
                ...
                .overrideTemplate(StockImsComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(StockImsComponent);
