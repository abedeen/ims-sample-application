...
import { UserGroupImsComponent } from 'app/entities/user-group-ims/user-group-ims.component';
...
describe('Component Tests', () => {
    describe('UserGroupIms Management Component', () => {
        let comp: UserGroupImsComponent;
        let fixture: ComponentFixture<UserGroupImsComponent>;
        let service: UserGroupImsService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [InventoryManagementSystemTestModule],
                declarations: [UserGroupImsComponent],
                providers: [
                    {
                ...
                .overrideTemplate(UserGroupImsComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(UserGroupImsComponent);
