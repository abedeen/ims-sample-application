...
public class OrdersResourceIntTest {
    ...
    private static final Long DEFAULT_PURCHASE_QUANTITY = 1L;
    private static final Long UPDATED_PURCHASE_QUANTITY = 2L;
     ...
     *
     * @see com.ims.application.repository.search.OrdersSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createOrders() throws Exception {
        ...
        assertThat(testOrders.getSku()).isEqualTo(DEFAULT_SKU);
        assertThat(testOrders.getPurchaseQuantity()).isEqualTo(DEFAULT_PURCHASE_QUANTITY);
    ...
    public void getAllOrders() throws Exception {
        ...
        restOrdersMockMvc.perform(get("/api/orders?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].purchaseQuantity").value(hasItem(DEFAULT_PURCHASE_QUANTITY.intValue())));
    }
    ...
    public void getOrders() throws Exception {
        ...
        restOrdersMockMvc.perform(get("/api/orders/{id}", orders.getId()))
            ...
            .andExpect(jsonPath("$.purchaseQuantity").value(DEFAULT_PURCHASE_QUANTITY.intValue()));
    }
    @Test
    @Transactional
    ...
    public void updateOrders() throws Exception {
        ...
        Orders testOrders = ordersList.get(ordersList.size() - 1);
        assertThat(testOrders.getSku()).isEqualTo(UPDATED_SKU);
        assertThat(testOrders.getPurchaseQuantity()).isEqualTo(UPDATED_PURCHASE_QUANTITY);
